                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nid_no" id="nid_no"
                                                    class="form-control <?php echo e($errors->has('nid_no') ? ' is-invalid' : ''); ?>"
                                                    value="<?php echo e(old('nid_no')); ?>">
                                                <?php if($errors->has('nid_no')): ?>
                                                    <span class="invalid-feedback">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fathers_profession" id="fathers_profession"
                                                    class="form-control <?php echo e($errors->has('fathers_profession') ? ' is-invalid' : ''); ?>"
                                                    value="<?php echo e(old('fathers_profession')); ?>">
                                                <?php if($errors->has('fathers_profession')): ?>
                                                    <span class="invalid-feedback">
                                                        <strong><?php echo e($errors->first('nid')); ?></strong>
                                                    </span>
                                                <?php endif; ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fathers_nid_no" id="fathers_nid_no"
                                                    class="form-control <?php echo e($errors->has('fathers_nid_no') ? ' is-invalid' : ''); ?>"
                                                    value="<?php echo e(old('fathers_nid_no')); ?>">
                                                <?php if($errors->has('fathers_nid_no')): ?>
                                                    <span class="invalid-feedback">
                                                        <strong><?php echo e($errors->first('nid')); ?></strong>
                                                    </span>
                                                <?php endif; ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="fathers_mobile_no" id="fathers_mobile_no"
                                                    class="form-control <?php echo e($errors->has('fathers_mobile_no') ? ' is-invalid' : ''); ?>"
                                                    value="<?php echo e(old('fathers_mobile_no')); ?>">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mothers_profession" id="mothers_profession"
                                                    class="form-control <?php echo e($errors->has('mothers_profession') ? ' is-invalid' : ''); ?>"
                                                    value="<?php echo e(old('mothers_profession')); ?>">
                                                <?php if($errors->has('mothers_profession')): ?>
                                                    <span class="invalid-feedback">
                                                        <strong><?php echo e($errors->first('mothers_profession')); ?></strong>
                                                    </span>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mothers_nid_no" id="mothers_nid_no"
                                                    class="form-control <?php echo e($errors->has('mothers_nid_no') ? ' is-invalid' : ''); ?>"
                                                    value="<?php echo e(old('mothers_nid_no')); ?>">
                                                <?php if($errors->has('mothers_nid_no')): ?>
                                                    <span class="invalid-feedback">
                                                        <strong><?php echo e($errors->first('nid')); ?></strong>
                                                    </span>
                                                <?php endif; ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="mothers_mobile_no" id="mothers_mobile_no"
                                                    class="form-control <?php echo e($errors->has('mothers_mobile_no') ? ' is-invalid' : ''); ?>"
                                                    value="<?php echo e(old('mothers_mobile_no')); ?>">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="designation" id="designation"
                                                    class="form-control <?php echo e($errors->has('designation') ? ' is-invalid' : ''); ?>"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="present_address" id="present_address"
                                                    ...
                                                    value="<?php echo e(old('present_address')); ?>"
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="guaranteer_information"
                                                                    ...
                                                                    class="form-control <?php echo e($errors->has('guaranteer_information') ? ' is-invalid' : ''); ?>"
                                                                    value="<?php echo e(old('guaranteer_information')); ?>"
                                                                    autocomplete="new-guaranteer_information">
                                                                <?php if($errors->has('guaranteer_information')): ?>
                                                                    <span class="invalid-feedback">
                                                                        <strong><?php echo e($errors->first('guaranteer_information')); ?></strong>
                                                                    </span>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="guaranteer_name"
                                                                    id="guaranteer_name"
                                                                    class="form-control <?php echo e($errors->has('guaranteer_name') ? ' is-invalid' : ''); ?>"
                                                                    value="<?php echo e(old('guaranteer_name')); ?>"
                                                                    autocomplete="new-guaranteer_name">
                                                                <?php if($errors->has('guaranteer_name')): ?>
                                                                    <span class="invalid-feedback">
                                                                        <strong><?php echo e($errors->first('guaranteer_name')); ?></strong>
                                                                    </span>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="guaranteer_relation"
                                                                    ...
                                                                    class="form-control <?php echo e($errors->has('guaranteer_relation') ? ' is-invalid' : ''); ?>"
                                                                    value="<?php echo e(old('guaranteer_relation')); ?>"
                                                                    autocomplete="new-guaranteer_relation">
                                                                <?php if($errors->has('guaranteer_relation')): ?>
                                                                    <span class="invalid-feedback">
                                                                        <strong><?php echo e($errors->first('guaranteer_relation')); ?></strong>
                                                                    </span>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="guaranteer_nid_no"
                                                                    ...
                                                                    class="form-control <?php echo e($errors->has('guaranteer_nid_no') ? ' is-invalid' : ''); ?>"
                                                                    value="<?php echo e(old('guaranteer_nid_no')); ?>"
                                                                    autocomplete="new-guaranteer_nid_no">
                                                                <?php if($errors->has('guaranteer_nid_no')): ?>
                                                                    <span class="invalid-feedback">
                                                                        <strong><?php echo e($errors->first('guaranteer_nid_no')); ?></strong>
                                                                    </span>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="guaranteer_mobile_no"
                                                                    ...
                                                                    class="form-control <?php echo e($errors->has('guaranteer_mobile_no') ? ' is-invalid' : ''); ?>"
                                                                    value="<?php echo e(old('guaranteer_mobile_no')); ?>"
                                                                    autocomplete="new-guaranteer_mobile_no">
                                                                <?php if($errors->has('guaranteer_mobile_no')): ?>
                                                                    <span class="invalid-feedback">
                                                                        <strong><?php echo e($errors->first('guaranteer_mobile_no')); ?></strong>
                                                                    </span>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="guaranteer_present_address"
                                                                    ...
                                                                    class="form-control <?php echo e($errors->has('guaranteer_present_address') ? ' is-invalid' : ''); ?>"
                                                                    value="<?php echo e(old('guaranteer_present_address')); ?>"
                                                                    autocomplete="new-guaranteer_present_address">
                                                                <?php if($errors->has('guaranteer_present_address')): ?>
                                                                    <span class="invalid-feedback">
                                                                        <strong><?php echo e($errors->first('guaranteer_present_address')); ?></strong>
                                                                    </span>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="guaranteer_permanent_address"
                                                                    ...
                                                                    class="form-control <?php echo e($errors->has('guaranteer_permanent_address') ? ' is-invalid' : ''); ?>"
                                                                    value="<?php echo e(old('guaranteer_permanent_address')); ?>"
                                                                    autocomplete="new-guaranteer_permanent_address">
                                                                <?php if($errors->has('guaranteer_permanent_address')): ?>
                                                                    <span class="invalid-feedback">
                                                                        <strong><?php echo e($errors->first('guaranteer_permanent_address')); ?></strong>
                                                                    </span>
                                                                <?php endif; ?>
                                                            </div>
                                                        </div>

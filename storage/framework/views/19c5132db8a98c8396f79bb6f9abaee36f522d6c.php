...
<?php $__env->startSection('title', 'Deliveryman Payment Summary'); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row ">
                        ...
                        <div class="col-lg-2">
                            <a class="btn btn-primary" href="<?php echo e(route('payment.deliveryman.invoice')); ?>">Invoices</a>
                        </div>
                    </div>
                    <br>
                    <br>
                        ...
                        <tbody id="reqtablenew">
                            <?php $__currentLoopData = $deliverymen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $deliveryman): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap"><?php echo e($deliveryman->name); ?></td>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a href="<?php echo e(url('/superadmin/payments/deliveryman-payments/all',$deliveryman->id)); ?>"
                                                class="btn btn-sm btn-primary">
                                                All Parcels
                                            </a>
                                            <br>
                                            <a href="<?php echo e(url('/superadmin/payments/deliveryman-payments/paid',$deliveryman->id)); ?>"
                                                class="btn btn-sm btn-success">
                                                Paid Parcels
                                            </a>
                                            <br>

                                            <a href="<?php echo e(url('/superadmin/payments/deliveryman-payments/due',$deliveryman->id)); ?>"
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/sensorbd/public_html/resources/views/backend/pages/superadmin/payments/deliveryman/deliveryman_payments_summary.blade.php ENDPATH**/ ?>
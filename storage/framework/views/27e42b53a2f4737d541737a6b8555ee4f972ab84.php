...
<?php $__env->startSection('title', 'Edit Percel'); ?>
                ...
                <div class="col-xl-8">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form role="form" action="<?php echo e(route('agent.percel.update')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="card-body">
                                            ...
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-sm-12">
                                                    <div>
                                                        ...
                                                        <label><input type="radio" name="colorRadio" value="outCityDhaka">
                                                            Out Side Dhaka</label>
                                                    ...
                                                    <div class="col-sm-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="division_id"
                                                                class="form-control select2 division_id" id="division_id"
                                                                required>
                                                    ...
                                                    <div class="col-sm-6 ">
                                                        ...
                                                        <div class="form-group">
                                                            <select name="district_id"
                                                                class="form-control select2 district_id" id="district_id"
                                                                required>
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\MIM Larvel\Mohuya Courier\MohuyaCourierService\resources\views/frontend/pages/agent/percel/edit.blade.php ENDPATH**/ ?>
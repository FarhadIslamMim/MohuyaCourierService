    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- Basic example -->
                    <form action="<?php echo e(route('payment.agent.invoice')); ?>" method="GET">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-lg-3">
                        ...
                        <tbody id="reqtablenew">
                            <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($invoice->getPercelDetails->agent->name ?? 'No name'); ?></td>
                                    <td> <?php echo e(\Carbon\Carbon::parse($invoice->created_at)->format('d M Y g:i A')); ?></td>
                                    <td>
                                         <a href="<?php echo e(route('payment.agent.invoice.export', $invoice->id)); ?>"
                                            class="btn btn-danger" target="_blank"><i class="fa fa-eye"></i></a>

                                        <a href="<?php echo e(route('payment.agent.invoice.print', $invoice->id)); ?>"
                                           class="btn btn-primary" target="_blank"><i class="fa fa-print" aria-hidden="true"></i></a>

                                        <a href="<?php echo e(route('payment.agent.invoice.download', $invoice->id)); ?>"
...
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/sensorbd/public_html/resources/views/backend/pages/superadmin/payments/agent/payment_invoice.blade.php ENDPATH**/ ?>
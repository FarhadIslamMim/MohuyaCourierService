                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    ...
                                    <form action="{{route('superadmin.auth.check')}}" method="post">
                                        @csrf
                                        <div class="mb-3">
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> {{$setting->name}}. Developed <i class="mdi mdi-heart text-danger"></i> by <a href="http://www.onepointitbd.com/">One Point IT Solutions</a>
                            </p>
                        </div>
                    </div>
                </div>

    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Pickupman Payment Summary</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Payments</a></li>
                        <li class="breadcrumb-item active">Pickupman Payment Summary</li>
                    </ol>
                </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <div class="row ">
                        <div class="col-lg-10">
                            <h3>Pickupman Payment Summary</h3>
                    ...
                    <div class="table-responsive">
                        <form action="{{ route('payment.pickupman.done') }}" method="POST">
                            @csrf
                            <div class="row">
                                @if ($type != 'paid')
                                    ...
                                    <table id="payment" class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-right">Pickupman Total</th>
                                        ...
                                        <tbody>
                                                ...
                                                <tr class="ml-1 sparent">
                                                    ...
                                                    <td>
                                                        @if ($parcel->pickupman_paid > 0)
                                                            <a href="{{ url('superadmin/pickupman-payment-invoice/' . $parcel->id) }}"
                                            ...
                                            <tr class="ml-1 sparent">
                                                ...
                                                <th class="text-right">{{ $pickupman_parcels->sum('pickupman_amount') }}
                                                </th>
                                                <th class="text-right">

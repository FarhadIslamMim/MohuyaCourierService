    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Agent Report</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Percel Manage</a></li>
                        <li class="breadcrumb-item active">Agent Report</li>
                    </ol>
                </div>
                            ...
                            <select name="agent_id" id="agent_id" class="form-control select2">
                                ...
                                @foreach ($agents as $agent)
                                    <option value="{{ $agent->id }}"
                                        @if (old('agent_id', $agent_info->id ?? '') == $agent->id) selected @endif>
                                                ...
                                                <table class="table table-sm">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 30%">
                                                                <span class="flex">
                                                                    Total Percel {{ number_format(count($parcels)) }}
                                                                </span>
                                                            </th>
                                                            <th style="width: 45%">
                                        ...
                                        <table class="table table-bordered table-sm" style="margin-top: 15px">
                                            ...
                                            <tbody>
                                                @foreach ($dailyparcels as $key => $parcel)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">{{ $parcel->parcelStatus->title ?? '' }}
                                                        </td>
                                            ...
                                            <tfoot>
                                                ...
                                                <tr class="custom">
                                                    <th colspan="8">Delivery Charge</th>
                                                    <th class="text-right">
                                                        {{ number_format($dailyparcels->sum('deliveryCharge'), 2) }}</th>
                                                </tr>
                                                <tr class="custom">
                                                    <th colspan="8">COD Charge</th>
                                                    <th class="text-right">
                                                        {{ number_format($dailyparcels->sum('codCharge'), 2) }}</th>
                                                </tr>
                                                {{-- <tr class="custom">
                                                    <th colspan="8">Total Payable </th>
                                                    <th class="text-right">
                                                        {{ number_format($dailyparcels->sum('pickupman_due'), 2) }}</th>
                                                </tr> --}}

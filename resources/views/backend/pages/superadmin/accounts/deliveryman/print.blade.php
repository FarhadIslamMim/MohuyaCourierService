                ...
                <div class="print_area">
                    <div class="print-header">
                        <div class="text-center">
                            ...
                            <br>
                            <br>
                            <p><b>Deliveryman Expense Invoice</b></p>
                        </div>
                    </div>
                    <div class="print-body">
                        <div class="col-lg-12">
                            <table style="width: 100%;">
                                <tbody>
                                    <tr>
                                        <td style="text-align: left;">Deliveryman :
                                            <b>{{ $deliveryman_man->deliverymanDetails->name }}</b> <br>
                                            <span>Phone Number : {{ $deliveryman_man->deliverymanDetails->phone }} </span>
                                        </td>

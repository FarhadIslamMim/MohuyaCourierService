...
@section('title', 'Deliveryman Update')
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header">
                    ...
                    @endif
                    <form role="form" action="{{ route('deliveryman.update') }}" method="POST"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="per_parcel_amount" id="per_parcel_amount"
                                                    ...
                                                    value="{{ old('per_parcel_amount', $edit_data->per_parcel_amount) }}" required>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <select name="max_weight" class="form-control select2" >
                                                    ...
                                                    <option value="1" {{($edit_data->max_weight === '1') ? 'Selected' : ''}}>Max 1 Kg</option>
                                                    <option value="2" {{($edit_data->max_weight === '2') ? 'Selected' : ''}}>Max 2 Kg</option>
                                                    <option value="3" {{($edit_data->max_weight === '3') ? 'Selected' : ''}}>Max 3 Kg</option>
                                                    <option value="4" {{($edit_data->max_weight === '4') ? 'Selected' : ''}}>Max 4 Kg</option>
                                                    <option value="5" {{($edit_data->max_weight === '5') ? 'Selected' : ''}}>Max 5 Kg</option>
                                                    <option value="6" {{($edit_data->max_weight === '6') ? 'Selected' : ''}}>Max 6 Kg</option>
                                                    <option value="7" {{($edit_data->max_weight === '7') ? 'Selected' : ''}}>Max 7 Kg</option>
                                                    <option value="8" {{($edit_data->max_weight === '8') ? 'Selected' : ''}}>Max 8 Kg</option>
                                                    <option value="9" {{($edit_data->max_weight === '9') ? 'Selected' : ''}}>Max 9 Kg</option>
                                                    <option value="10" {{($edit_data->max_weight === '10') ? 'Selected' : ''}}>Max 10 Kg</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control"  value="{{$edit_data->extra_weight_charge ?? 0}}" placeholder="price" name="extra_weight_charge">
                                            </div>
                                        </div>
                                        {{-- <div class="col-sm-12">
                                            <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="district_id" id="district_id"
                                                                        class="form-control select2 {{ $errors->has('district_id') ? ' is-invalid' : '' }}"
                                                                        value="{{ old('district_id') }}" required>
                                                                        <option value="">Select Division</option>
                                                                        @foreach ($districts as $district)
                                                                            <option value="{{ $district->id }}"
                                                                                @if (old('district_id', $edit_data->district_id) == $district->id) selected @endif>
                                                                                {{ $district->name }}
                                                                            </option>
                                                                        @endforeach
                                                                    </select>

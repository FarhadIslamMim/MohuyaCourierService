...
@section('title', 'Generate Multilabel')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Multi Label Generate</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Percel</a></li>
                        <li class="breadcrumb-item active">Multi Label Generate</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div id="printTable" style="width:288px; height:288px; background:#fff; border:1px solid #282828;">
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td style="width:280px">
                                            ...
                                            <span style="font-size: 12px">
                                                District:&nbsp;{{ $parcel->merchant->district->name ?? '' }} </span>&nbsp;
                            ...
                            <div style="border-bottom:1px solid">
                                <table>
                                    <tr>
                                        <td style="width:245px; border-right:1px solid black;line-height: 15px;">
                                            <strong style="font-size:11px">CUSTOMER:
                                                {{ $parcel->recipientName ?? '' }}</strong><br>
                                            <span style="font-size:11px"> {{ $parcel->recipientPhone ?? '' }}</span><br>
                                            <span style="font-size:11px"> {{ $parcel->recipientAddress ?? '' }}</span><br>
                                            <span style="font-size:11px;"> {{ $parcel->alternative_mobile_no ?? '' }} (Alt.
                                                No.)</span>

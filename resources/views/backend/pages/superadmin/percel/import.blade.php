    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Percel Create</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Percel</a></li>
                        <li class="breadcrumb-item active">Percel Create</li>
                    </ol>
                </div>
            ...
            @if (count($temp_files) > 0)
                <div class="card">
                    <div class="card-header">
                        ...
                        <form action="{{ route('admin.import.parcel.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    value="{{ $temp->invoice_no }}" name="invoiceNo[]"
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    name="recipientName[]" placeholder="Customer Name *">
                                                                @if ($errors->has('name'))
                                                                    <span class="invalid-feedback">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="delivery_address[]"
                                                                    ...
                                                                    value="{{ $temp->delivery_address }}" required />
            ...
            @else
                <div class="card">
                    <div class="card-header">
                        ...
                        <form role="form" action="{{ route('admin.import.parcel.read') }}" method="post"

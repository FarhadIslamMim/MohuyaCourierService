        ...
        <div class="col-xl-12">
            <div class="card">
                        ...
                        <div class="row gy-4">
                                ...
                                <select name="thana_id" id="thana_id" class="form-control select2" required>
                                    ...
                                    @foreach ($thanas as $thana)
                                        <option value="{{ $thana->id }}"
                                            @if (old('thana_id', $edit_data->thana_id) == $thana->id) selected @endif>
                                            {{ $thana->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="coverage" id="coverage" class="form-control select2" required>
                                    <option value="1" @if (old('coverage', $edit_data->coverage) == 1) selected @endif> Yes</option>
                                    <option value="0" @if (old('coverage', $edit_data->coverage) == 0) selected @endif>No </option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="pickup" id="pickup" class="form-control select2" required>
                                    <option value="1" @if (old('pickup', $edit_data->pickup) == 1) selected @endif> Yes</option>
                                    <option value="0" @if (old('pickup', $edit_data->pickup) == 0) selected @endif> No </option>
                                </select>
                            </div>
                ...
                <div class="card-footer">
                    <input type="submit" value="Update area" class="btn btn-success">
                </div>
                </form>

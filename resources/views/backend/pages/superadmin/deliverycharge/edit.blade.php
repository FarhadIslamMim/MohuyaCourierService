...
@section('main-content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Delivery Charge Edit</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Delivery Charge Edit</a></li>
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('dc.update')}}" method="POST" enctype="multipart/form-data"
                        name="editForm">
                        @csrf
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" name="return_charge" id="return_charge"
                                            ...
                                            value="{{ old('return_charge', $edit_data->return_charge) }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="box-body pub-stat display-inline">
                                            <input class="" type="radio" id="active" name="status"
                                                value="1" @if (old('status', $edit_data->status) == 1) checked @endif>
                                        ...
                                        <div class="box-body pub-stat display-inline">
                                            <input class="" type="radio" name="status" value="0"
                                                id="inactive" @if (old('status', $edit_data->status) == 0) checked @endif>

                                ...
                                <div class="col-md-3">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <img class="photo"
                                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuLGj3eqsqxmOGDp6UuhpF5u4U4yhVavidzY9JynQqrpUwcWcXhWglKvqiOOGboa7sG1k&usqp=CAU"
                                                alt="Photo" width="100" height="100"> <br>
                                            <span class="badge badge-soft-primary">ID - {{ $merchantInfo->id }}</span>
                                            <br>

                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <p class="invoice-number me-4"><b>Invoice No:
                                                </b>#0{{ $marchant_details->paymentInvoice ?? '' }}</p>
                                        </div>
                                        <div class="col-auto">
                                            <p class="invoice-date"><b>Date:
                                                </b>{{ date('d-m-Y', strtotime($marchant_details->updated_at ?? '')) }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-between mb-4">
                                <div class="col-auto">
                                    <div class="invoice-left">
                                        <b>Invoiced To:</b>
                                        <address>
                                            {{ $marchant_details->merchant->companyName ?? '' }}<br />
                                            {{ $marchant_details->merchant->pickLocation ?? '' }}<br />
                                        </address>
                                    </div>
                                </div>
                                <div class="col-auto">
                            ...
                            <table class="invoice-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <b><strong>{{ number_format($data->sum('c_charge'), 2) }}</strong></b>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            @php
                                              $totalAmount =  $amounts->sum('collected_amount') - ($amounts->sum('deliveryCharge') + $amounts->sum('return_charge') + $data->sum('c_charge'))
                                            @endphp

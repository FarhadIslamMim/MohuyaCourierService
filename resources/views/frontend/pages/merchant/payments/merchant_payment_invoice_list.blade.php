            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{route('merchant.payment.invoice')}}" method="GET">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-4">
                                ...
                                <tbody id="reqtablenew">
                                    @foreach ($invoices as $invoice)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('merchant.payment.invoice.details', $invoice->id) }}"
                                                    class="btn btn-danger"><i class="las la-file-pdf"></i></a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>

...
{{--                                                            @endif--}}
                                                        ...
                                                        <td>
                                                            ...
                                                            @endif --}}
                                                                ...
                                                                <!-- @if ($value->status >= 2)
    -->
                                                                <!--<a class="btn btn-sm btn-primary" a href="{{ url('deliveryman/parcel/invoice/' . $value->id) }}"  title="Invoice"><i class="fas fa-list"></i></a>-->
                                                                <!--
    @endif-->
                                                                {{-- <a class="btn btn-sm btn-sm btn-danger"
...
@section('custom-scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#collected_amount").hide();
            $("#example").DataTable();
            // delivery status
        });

        function parcelDelivery(id) {
            var parcel_status_id = $('#delivery_status').val();
            if (parcel_status_id == 4) {
                $("#collected_amount").show();
            } else {
                $("#collected_amount").hide();

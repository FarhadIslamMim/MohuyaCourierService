...
@section('title', 'Pickupman Reports')
                        ...
                        <div class="row gy-4">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Select Pickupman</label>
                                        ...
                                        @foreach ($pickupmans as $pickupman)
                                            @foreach ($pickupman->getPickupMan as $item)
                                                <option value="{{ $item->id }}"
                                                    @if (old('pickupman_id', $pickupman_info->id ?? '') == $item->id) selected @endif>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <table class="table table-sm">
                                                            <thead>
                                                                <tr>
                                                                    <th style="width: 25%">
                                                                        <span class="pickupman_info flex">
                                                                            <b>Pickupman Person:</b>

        ...
        <article>
            <div class="container">
                <div class="main-content">
                    <div class="row">
                        {{-- @include('frontend.pages.pickupman.layouts.sidebar') --}}
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3>Welcome, {{ $pickupmanInfo->name }}</h3>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="stats-reportList-inner">
                                                <div class="row">
                                                    ...
                                                    <!-- col end -->
                                                    <div class="col-lg-2 colo-md-2 col-sm-2 col-6">
                                                        <a href="{{ route('pickupman.percels') }}?parcel_type=hold">
                                                    ...
                                                    <!-- col end -->
                                                    <div class="col-lg-2 colo-md-2 col-sm-2 col-6">
                                                        <a href="{{ route('pickupman.percels') }}?parcel_type=deliverd">
                                                    ...
                                                    <!-- col end -->
                                                    <div class="col-lg-2 colo-md-2 col-sm-2 col-6">
                                                        <a href="{{ route('pickupman.percels') }}?parcel_type=cancelled') }}">
                                                    ...
                                                    <div class="col-lg-2 colo-md-2 col-sm-2 col-6">
                                                        <a
                                                            href="{{ route('pickupman.percels') }}?parcel_type=return-pending">
                                                    ...
                                                    <div class="col-lg-2 colo-md-2 col-sm-2 col-6">
                                                        <a
                                                            href="{{ route('pickupman.percels') }}?parcel_type=return-to-merchant">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="stats-reportList-inner">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2 colo-md-2 col-sm-2 col-6">
                                                        <a
                                                            href="{{ url('pickupman/parcels?parcel_type=return-pending') }}">
                                                            <div class="stats-reportList bg-info">
                                                                <div class="stats-per-item">
                                                                    <h5>Total Pending</h5>
                                                                    <h3>{{ $returnpendin }}</h3>
                                                    ...
                                                    <div class="col-lg-2 colo-md-2 col-sm-2 col-6">
                                                        <a
                                                            href="{{ url('pickupman/parcels?parcel_type=return-to-merchant') }}">
                                                            <div class="stats-reportList bg-danger">
                                                                <div class="stats-per-item">

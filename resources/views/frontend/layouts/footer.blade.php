    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 mt-4">
                <div>
                    <div>
                        <img src="{{ asset($setting->logo) }}" alt="logo light" height="80">
                    </div>
                    ...
                    <div class="col-sm-4 mt-4">
                        ...
                        <div class="text-muted mt-3">
                            <ul class="list-unstyled ff-secondary footer-list fs-14">
                                ...
                                <li><a href="{{ route('home') }}#hubs">Hubs</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-4 mt-4">
            ...
            <div class="col-sm-6">
                ...
                <div>
                    <p class="copy-rights mb-0">
                        ...
                        </script> © {{ $setting->name }} - Developed by <a
                ...
                <div class="text-sm-end mt-3 mt-sm-0">
                    <ul class="list-inline mb-0 footer-social-link">
                        <li class="list-inline-item">
                            <a href="{{ $setting->facebook }}" class="avatar-xs d-block">
                        ...
                        <li class="list-inline-item">
                            <a href="{{ $setting->twitter }}" class="avatar-xs d-block">
                                <div class="avatar-title rounded-circle">
